...
def main():
    os.chdir("/hapidocindexer/hapidoccore")
    call_name_reg = os.environ['CALL_NAME']
    ...
    for dataset in projects_map:
        ...
        params_pre = {'metric': 'lcs', 'remove_singletons': False, 'remove_pseudo_singletons': False,
                      'remove_unique': False, 'call_name': call_name_reg}
        ...
        params_clust = {'algorithm': 'k-medoids', 'params': {'k': non_identical, 't_max': 100, 'init': 'k-medoids++', 'criterion': 'medoids'}}
